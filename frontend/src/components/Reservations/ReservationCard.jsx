...
import styled from 'styled-components';
import { format } from 'date-fns';
import { FaBook, FaHome, FaCheck, FaTimes, FaClock, FaBoxOpen, FaReply } from 'react-icons/fa';
  ...
  const getStatusIcon = () => {
    switch (reservation?.status) {
      ...
      case 'declined':
        return <FaTimes color="red" />;
      case 'checked_out':
        return <FaBoxOpen color="blue" />;
      case 'returned':
        return <FaReply color="purple" />;
      default:
        return <FaClock color="orange" />;
    }
  };
console.log("reservations",reservation)
  return (
    <Card>
      <CardHeader>
        ...
        <Title>
          {reservation.type === 'book' 
            ...
            : reservation.room?.name || 'Room Reservation'}
        </Title>
        <Status>
          {getStatusIcon()} {reservation.status}
        </Status>
      ...
      <CardBody>
        <Detail>
          <strong>User:</strong> {reservation.user?.username || 'N/A'}
        </Detail>
        <Detail>
          <strong>Pickup Date:</strong> {format(new Date(reservation.pickupDate), 'PPpp')}
        </Detail>
